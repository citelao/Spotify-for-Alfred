...
Latest version: [v0.9.2](https://github.com/citelao/Spotify-for-Alfred/archive/master.zip) | Latest dev build: [v0.9.2](https://github.com/citelao/Spotify-for-Alfred/archive/dev.zip)
